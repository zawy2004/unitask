...
export const jobsData: Job[] = [
  ...
  // ── Content jobs ──
  {
    ...
    logoText: 'VL',
    logoGradient: 'linear-gradient(135deg,#00D4AA,#00A882)',
    title: 'Viết kịch bản video TikTok (20 video)',
    company: 'ViralLab Studio',
    verified: true,
    location: 'Remote',
    tags: [
      { label: '✍️ Content', variant: 't' },
  ...
  },
  {
    ...
    logoText: 'EC',
    logoGradient: 'linear-gradient(135deg,#FFB340,#FF8C00)',
    title: 'Viết mô tả sản phẩm Shopee (50 sản phẩm)',
    company: 'EcomBoost VN',
    verified: true,
    location: 'Remote',
    tags: [
      { label: '✍️ Content', variant: 't' },
  ...
  },
  {
    ...
    logoText: 'TP',
    logoGradient: 'linear-gradient(135deg,#7C72FF,#5B4FFF)',
    title: 'Viết Newsletter hàng tuần — Ngành công nghệ',
  ...
  },
  {
    ...
    logoText: 'FD',
    logoGradient: 'linear-gradient(135deg,#FF6B35,#FF4D6B)',
    title: 'Content Creator — Fanpage Ẩm thực',
    company: 'FoodieDaily VN',
    verified: true,
    location: 'Hồ Chí Minh',
    tags: [
      { label: '✍️ Content', variant: 't' },
      { label: 'Hybrid', variant: 'a' },
    ],
    spotsLeft: 2,
    spotsTotal: 3,
    pay: '💰 1.500.000 – 2.800.000 ₫',
    deadline: '⏰ Còn 9 ngày',
    category: 'content',
  },
  {
    id: 11,
    logoText: 'SV',
    logoGradient: 'linear-gradient(135deg,#00A882,#00D4AA)',
    title: 'Biên soạn tài liệu hướng dẫn sử dụng App',
    company: 'StartupViet Hub',
    verified: true,
    location: 'Remote',
    tags: [
      { label: '✍️ Content', variant: 't' },
  ...
  // ── Marketing jobs ──
  {
    ...
    logoText: 'DM',
    logoGradient: 'linear-gradient(135deg,#5B4FFF,#7C72FF)',
    title: 'Chạy Google Ads — Landing Page Khóa học',
    company: 'DigiMaster Academy',
    verified: true,
    location: 'Remote',
    tags: [
      { label: '📢 Marketing', variant: 'g' },
  ...
  },
  {
    ...
    logoText: 'BZ',
    logoGradient: 'linear-gradient(135deg,#FF4D6B,#FF6B35)',
    title: 'Quản lý Fanpage & Lên lịch đăng bài',
    company: 'BizSocial Agency',
    verified: true,
    location: 'Hà Nội',
    tags: [
      { label: '📢 Marketing', variant: 'g' },
  ...
  },
  {
    ...
    logoText: 'SH',
    logoGradient: 'linear-gradient(135deg,#FFB340,#FF8C00)',
    title: 'SEO Audit & Tối ưu On-page cho Website',
    company: 'ShopeePartner VN',
    verified: true,
    location: 'Remote',
    tags: [
      { label: '📢 Marketing', variant: 'g' },
  ...
  },
  {
    ...
    logoText: 'KS',
    logoGradient: 'linear-gradient(135deg,#00D4AA,#00A882)',
    title: 'Lên chiến lược KOL Seeding — Mỹ phẩm',
    company: 'K-Skin Cosmetics',
    verified: true,
    location: 'Hồ Chí Minh',
    tags: [
      { label: '📢 Marketing', variant: 'g' },
  ...
  },
  {
    ...
    logoText: 'AF',
    logoGradient: 'linear-gradient(135deg,#7C72FF,#5B4FFF)',
    title: 'Setup Email Marketing Automation (Mailchimp)',
    company: 'AutoFlow SaaS',
    verified: true,
    location: 'Remote',
    tags: [
      { label: '📢 Marketing', variant: 'g' },
  ...
  },
  {
    id: 17,
    logoText: 'TL',
    logoGradient: 'linear-gradient(135deg,#FF6B35,#FFB340)',
    title: 'Chạy TikTok Ads — App di động',
    company: 'TechLaunch VN',
    verified: true,
    location: 'Remote',
    tags: [
      { label: '📢 Marketing', variant: 'g' },
